 ...
 * [rosettastmtont.yml](rosettastmtont.yml)
     * Determines how your purl.obolibrary.org/obo/rosettastmtont/ redirects will be handled
     ...
     * Paste in the contents of [rosettastmtont.yml](rosettastmtont.yml)
 ...
 * [rosettastmtont.md](rosettastmtont.md)
     ...
     * Paste in the contents of [rosettastmtont.md](rosettastmtont.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
